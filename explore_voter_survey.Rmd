...
Sadly, for a libertarian, the scores tend to line up along the 45 degree axis, which means people who are more socially conservative are more likely to be fiscally conservative as well. The libertarian quadrant is the upper left, which is more sparseley populated.
...
I went through the *YouGov.com* survey and picked out the questions I feel are relevant, a higly subjective exercise. Even so,the results do not support my hope that maybe a plurality of people have libertarian sensibilities.  But there were hints that gave me some hope.
